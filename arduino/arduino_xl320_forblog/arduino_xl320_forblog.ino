...
//0x03 (write)
//Parameters:
//0x19 (address of LED byte) 0x00 VALUE
//16 Bit CRC:
...
void loop() {
    ...
    //SEND LED ON COMMAND
    unsigned char TxPacket[13] = { 0xFF, 0xFF, 0xFD, 0x00, 0xFE, 0x06, 0x00, 0x03, 0x19, 0x00, 0x01, CRC_L, CRC_H };
    ...
    unsigned char TxPacket3[14] = { 0xFF, 0xFF, 0xFD, 0x00, 0xFE, 0x07, 0x00, 0x02, 0x2E, 0x00, 0x01, 0x00, CRC_L, CRC_H };
    CRC = update_crc(0, TxPacket3, 12);
    CRC_L = (CRC & 0x00FF);
    CRC_H = (CRC>>8) & 0x00FF;
    TxPacket3[12] = CRC_L;
    TxPacket3[13] = CRC_H;
    Serial1.write(TxPacket3,14);
    delay(20);
